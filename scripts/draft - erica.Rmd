...
# Save the result
save(db_tune_rf, file = 'db_tune_rf.rda')
...
```{r}
autoplot(db_tune_rf) + theme_minimal()
```

```{r}
show_best(db_tune_rf, n = 1)
...
# Assuming knn_fit, log_fit, and bt_mode_fit are your fitted models
# Replace "Outcome" and ".pred_0" with your actual column names
...
```{r}
print(bt_mode_fit$predict)
print(bt_mode_fit$.pred_0)
